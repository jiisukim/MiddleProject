...
public class HostNoticeDao implements IHostNoticeDao{
	...
	public int getTotalCnt(SqlMapClient smc) throws SQLException {
		int cnt = (int)smc.queryForObject("hostNotice.getTotalCnt");
		return cnt;
	}
	...
	@Override
	public NoticeVO searchNotice(SqlMapClient smc, String ntcTitle) throws SQLException {
		NoticeVO nv = (NoticeVO)smc.queryForObject("hostNotice.searchNotice", ntcTitle);
		return nv;
	}
