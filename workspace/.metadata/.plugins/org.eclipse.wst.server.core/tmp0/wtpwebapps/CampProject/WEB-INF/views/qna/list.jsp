	...
	<table class="type09" border="1">
		...
		<tbody>
			<tr>
				...
				<td><a
					href="view.do?qnaCode=<%= qnaCode %>"><%= qnaList.get(i).getQnaTitle() %></a></td>
<!-- 					a태그 라서 반드시 태그 사이에 내용. href는 코드번호-->
				<td style="width: 200px;"><%= qnaList.get(i).getMemNick() %></td> 
		...
		<% 		
			...
			%>
		<tr align="center">
			<td colspan="4">Q&A가 올라오지 않았습니다.</td>
		</tr>
		<%
			}
		%>
		<tr align="center">
			<td colspan="4"><a href="insert.do">[Q&A 등록]</a></td>
		</tr>
