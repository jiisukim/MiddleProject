...
<body class="d-flex flex-column h-100">
				...
				<div class="row gx-0">
					<div class="col-lg-6 col-xl-7">
						<div class="bg-featured-blog"
							style="background-image: url('images/partner1.jpg')"></div>
					</div>
					<div class="col-lg-6 col-xl-5 py-lg-5">
						<div class="p-4 p-md-5">
							...
							<div class="h2 fw-bolder">오두막 캠핑장</div>
							<br>
							<p><strong>Tel. </strong> 041-950-4028 </p>
							<p><strong>Price. </strong> 18,000 원 </p>
							<p><strong>Number. </strong> 3 명 </p>
	...
	<section class="py-5">
	<div class="container px-5">
		<h2 class="fw-bolder fs-5 mb-4">카카오 지도 테스트</h2>
		<div>			
